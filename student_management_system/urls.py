...
urlpatterns = [
    ...
    path('staff_feedback_reply', HodViews.staff_feedback_reply,name="staff_feedback_reply"),
    path('student_feedback_message', HodViews.student_feedback_message,name="student_feedback_message"),
    path('student_feedback_reply', HodViews.student_feedback_reply,name="student_feedback_reply"),
